...
// === UPDATED POPUP ADD TO CART HANDLER WITH PACKAGING ===
function setupPopupAddToCartHandler(card, addToCartButton, cardIndex) {
    ...
    addToCartButton.addEventListener('click', function (e) {
        ...
        // Get packaging cost from the popup card title
        const cardTitlePopup = card.querySelector('.h3_title-pop_up-card');
        ...
        // Get packaging cost from the popup card
        const packagingCost = cardTitlePopup ? (parseInt(cardTitlePopup.getAttribute('packaging')) || 0) : 0;
        ...
        if (existingItem) {
            ...
            const cartItem = createCartItemHTML({
                ...
                packaging: packagingCost.toString(), // Use packaging cost from popup
                isWeightBased: false,
                weightStep: 1,
                minWeight: 1,
                referenceWeight: 1,
